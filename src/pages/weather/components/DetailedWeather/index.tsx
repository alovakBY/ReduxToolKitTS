...
export const DetailedWeather: FC<IDetailedWeatherProps> = ({
   ...
   const windInfo =
      ...
      utils.getWindInfo(selectedDay.wind_deg, selectedDay.wind_speed, isMetric);
         ...
         <div className={classes.bottom}>
               ...
               <div className={classes.bottomWrapper}>
                  ...
                  >
                     {isMetric ? (
                        <>
                           <span>F</span>/
                           <span className={classes.activeMetric}>C</span>
                        </>
                     ) : (
                        <>
                           <span className={classes.activeMetric}>F</span>/
                           <span>C</span>
                        </>
                     )}
                  </sup>
            ...
            <div className={classes.bottomRight}>
               ...
               {selectedDay.air_quality && (
                  <div>AirQuality: {AIR_QUALITY[selectedDay.air_quality]}</div>
               )}
            </div>
         </div>
      </div>
